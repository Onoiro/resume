...
Использую: IDE - **VS Code**, терминал - **Terminator**, среда - **Ubuntu**
...
Закончил обучение по дополнительной профессиональной программе **Нейросети: работа с системами искусственного интеллекта**.

Закончил курс по профессии **Python-разработчик** на **Hexlet** где обучился разработке бэкенда сайтов и веб-приложений.

В течении этого 2025 года прошел онлайн-курсы:
- Docker с нуля (Karpov.courses)
- Системный администратор Linux с нуля (Selectel)

Самостоятельное обучение по книгам:
- Алгоритмы и структуры данных (А. Бхаргава "Грокаем алгоритмы")
- Основы CS и архитектуры компьютеров (Ч. Петцольд "Код")
- Best practices разработки (С. МакКоннелл "Совершенный код", Э. Хант "Программист-прагматик")
- Python (Э. Мэтиз "Изучаем Python")

Закончил различные онлайн-курсы по Python, SQL, веб на платформах **GeekBrains**, **Netology**, **Sololearn** - [сертификаты](https://github.com/Onoiro/Certificates) имеются.
